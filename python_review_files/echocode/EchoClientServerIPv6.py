...
class Server:
    ...
    # binding. Note that :: or "" serves as INADDR_ANY. i.e., bind to
    # all local IPv6 network interface addresses.
    HOSTNAME = "::"
    ...
    # Create server IPv6 socket address. It is a tuple containing
    # address/hostname, port. flow info and scope id.
    SOCKET_ADDRESS = (HOSTNAME, PORT, 0, 0)
...
class Client:
    ...
    def connect_to_server(self):
        try:
            ...
            self.socket.connect((Client.SERVER_HOSTNAME, Server.PORT, 0, 0))
        except Exception as msg:
            print(msg)
            sys.exit(1)
