...
class Client:
    ...
    def connection_receive(self):
        try:
            total_num_recvd_bytes = 0
            recvd_msg = ""
            total_recvd_bytes = bytearray()
            msg_length_in_bytes = len(self.input_text.encode(Server.MSG_ENCODING))

            while total_num_recvd_bytes < msg_length_in_bytes:
                ...
                total_num_recvd_bytes += len(recvd_bytes)
            ...
            print("Received: ", total_recvd_bytes.decode(Server.MSG_ENCODING))
